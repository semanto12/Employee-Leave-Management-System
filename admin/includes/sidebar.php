     <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons"></i>Department</a>
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons"></i>Leave Type</a>
                        <div class="collapsible-body">
                            <ul>
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons"></i>Employees</a>
                        <div class="collapsible-body">
                            <ul>
   ...
   <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons"></i>Leave Managements</a>
                        <div class="collapsible-body">
                            <ul>
                   ...
                   <div class="footer">
                    <p class="copyright">Brought To You By<a href="#">Semanto Dev</a>©</p>
